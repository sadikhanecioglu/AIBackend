...
class ConfigManager:
    ...
    def _load_from_env(self) -> Dict[str, Any]:
        ...
        if os.getenv("VERTEXAI_SERVICE_ACCOUNT_JSON"):
            env_config["vertexai_service_account_json"] = os.getenv(
                "VERTEXAI_SERVICE_ACCOUNT_JSON"
            )
        if os.getenv("VERTEXAI_PROJECT_ID"):
