...
async def direct_speech_example():
    ...
    request = SpeechRequest(
        audio_data=audio_file, language="tr", timestamps=True  # Türkçe
    )
...
def create_test_audio():
    ...
    try:
        ...
        os.system(
            'say "Merhaba, bu bir test mesajıdır. AI Gateway STT özelliğini test ediyoruz." --output-file=test_audio.aiff'
        )
...
async def main():
    ...
    if audio_file and os.path.exists(audio_file):
        ...
        print(
            "❌ Test için ses dosyası gerekli. Lütfen 'test_audio.mp3' veya 'test_audio.wav' dosyası ekleyin."
        )
